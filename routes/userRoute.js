				...
				const ourtoppers = [
					{
						...
						collegename: "",
						cloudinaryname: "",
						studentimg: "https://res.cloudinary.com/drrp3kgsn/image/upload/v1718121844/ClassicNeet_Toppers_2024/bkeyhwxyc0ungoeuv4pt.jpg",
						score: "700",
					},
					{
						name: "ABBAS S N",
						collegename: "",
						cloudinaryname: "",
						studentimg: "https://res.cloudinary.com/drrp3kgsn/image/upload/v1718121844/ClassicNeet_Toppers_2024/jrnjdpaycgjmdlh34pp9.jpg",
						score: "695",
					},
					{
						name: "AMEEN A",
						collegename: "",
						cloudinaryname: "",
						studentimg: "https://res.cloudinary.com/drrp3kgsn/image/upload/v1718121844/ClassicNeet_Toppers_2024/razpljtqx1flgerjuncy.jpg",
						score: "690",
					},
					{
						name: "NANDHINI B",
						collegename: "",
						cloudinaryname: "",
						studentimg: "https://res.cloudinary.com/drrp3kgsn/image/upload/v1718121844/ClassicNeet_Toppers_2024/riqcvijf8t2m0hy3ewzk.jpg",
						score: "689",
					},
					{
						name: "VISWA M",
						collegename: "",
						cloudinaryname: "",
						studentimg: "https://res.cloudinary.com/drrp3kgsn/image/upload/v1718121844/ClassicNeet_Toppers_2024/cte0ufmkwgmwk62ihgyf.jpg",
						score: "688",
					},
...
router.route('/aboutus').get(async (req, res) => {
	...
	await db.query('SELECT * FROM history', async (error, response) => {
		...
		if (error) {
			...
			await db.query('SELECT * FROM foundervideo', async (error, response) => {
				if (error) {
					req.flash('error', 'Error occurred while adding');
					console.log(error);
				} else {
				...
				await db.query(
					'SELECT content1,content2 FROM ourfounder',
					async (error, response) => {
						if (error) {
							console.log(error);
						} else {
							const ourFounderContent1 = response[0].content1;
							const ourFounderContent2 = response[0].content2;
							res.render('aboutus', {
								content: arr,
...
router
	.route('/admin/aboutus/ourfounder')
	.get(flash, isloggedin, async (req, res) => {
		await db.query(
			'SELECT content1,content2 FROM ourfounder',
			async (error, response) => {
				if (error) {
					...
					res.render('admin/aboutus/ourfounder', {
	...
	.post(async (req, res) => {
		await db.query(
			'UPDATE ourfounder SET content1 = ?, content2 = ?',
			[req.body.content1, req.body.content2],
			(err, response) => {
				if (err) {
					req.flash('error', 'Error occurred while updating');
					console.log(err);
					res.redirect('/admin/aboutus/ourfounder');
				} else {
					req.flash('success', 'Successfully Updated');
					res.redirect('/admin/aboutus/ourfounder');
				}
...
router
	.route('/admin/branch/salemcontent')
	.get(flash, isloggedin, async (req, res) => {
		await db.query(
			'SELECT content1,content2 FROM salemcontent',
			async (error, response) => {
				if (error) {
					console.log(error);
				} else {
					res.render('admin/branch/salemcontent', {
						content1: response[0].content1,
						content2: response[0].content2
					});
				}
	...
	.post(async (req, res) => {
		await db.query(
			'UPDATE salemcontent SET content1 = ?, content2 = ?',
			[req.body.content1, req.body.content2],
			(err, response) => {
				if (err) {
					req.flash('error', 'Error occurred while updating');
					console.log(err);
					res.redirect('/admin/branch/salemcontent');
				} else {
					req.flash('success', 'Successfully Updated');
					res.redirect('/admin/branch/salemcontent');
				}
...
router
	.route('/admin/branch/namakkalcontent')
	.get(flash, isloggedin, async (req, res) => {
		await db.query(
			'SELECT content1,content2 FROM namakkalcontent',
			async (error, response) => {
				if (error) {
					console.log(error);
				} else {
					res.render('admin/branch/namakkalcontent', {
						content1: response[0].content1,
						content2: response[0].content2
					});
				}
	...
	.post(async (req, res) => {
		await db.query(
			'UPDATE namakkalcontent SET content1 = ?, content2 = ?',
			[req.body.content1, req.body.content2],
			(err, response) => {
				if (err) {
					req.flash('error', 'Error occurred while updating');
					console.log(err);
					res.redirect('/admin/branch/namakkalcontent');
				} else {
					req.flash('success', 'Successfully Updated');
					res.redirect('/admin/branch/namakkalcontent');
				}
...
router
	.route('/admin/branch/dharmapuricontent')
	.get(flash, isloggedin, async (req, res) => {
		await db.query(
			'SELECT content1,content2 FROM dharmapuricontent',
			async (error, response) => {
				if (error) {
					console.log(error);
				} else {
					res.render('admin/branch/dharmapuricontent', {
						content1: response[0].content1,
						content2: response[0].content2
					});
				}
	...
	.post(async (req, res) => {
		await db.query(
			'UPDATE dharmapuricontent SET content1 = ?, content2 = ?',
			[req.body.content1, req.body.content2],
			(err, response) => {
				if (err) {
					req.flash('error', 'Error occurred while updating');
					console.log(err);
					res.redirect('/admin/branch/dharmapuricontent');
				} else {
					req.flash('success', 'Successfully Updated');
					res.redirect('/admin/branch/dharmapuricontent');
				}
...
router
	.route('/admin/branch/vellorecontent')
	.get(flash, isloggedin, async (req, res) => {
		await db.query(
			'SELECT content1,content2 FROM vellorecontent',
			async (error, response) => {
				if (error) {
					console.log(error);
				} else {
					res.render('admin/branch/vellorecontent', {
						content1: response[0].content1,
						content2: response[0].content2
					});
				}
	...
	.post(async (req, res) => {
		await db.query(
			'UPDATE vellorecontent SET content1 = ?, content2 = ?',
			[req.body.content1, req.body.content2],
			(err, response) => {
				if (err) {
					req.flash('error', 'Error occurred while updating');
					console.log(err);
					res.redirect('/admin/branch/vellorecontent');
				} else {
					req.flash('success', 'Successfully Updated');
					res.redirect('/admin/branch/vellorecontent');
				}
